<div class="title-container align-items-center gap-2 d-flex">
	...
	<div class="{{{ if !template.compose }}}d-none d-md-flex{{{ else }}}d-flex{{{ end }}} action-bar gap-1 align-items-center">
		...
		<i class="fa fa-user-secret"  style="color: black; opacity: 1;"></i><span class="btn btn-sm btn-link text-body fw-semibold" style="pointer-events: none; cursor: default;"><strong>Anonymous</strong></span>
		</label>
